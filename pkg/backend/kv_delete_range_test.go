			...
			appendChecksWithIncompleteMetadata = func(
				...
				checks = append(
					...
					check{
						...
						expectMetaHead:            expectMetaHead(newMetaHead, newDataHead, true),
			...
			appendChecksWithIncompleteMetadata = func(
				...
				return append(
					...
					check{
						...
						req:                       &etcdserverpb.DeleteRangeRequest{Key: key, RangeEnd: rangeEnd, PrevKv: true},
						matchErr:                  HaveOccurred(),
						expectMetaHead:            expectMetaHead(currentMetaHead.DeepCopy(), currentDataHead.DeepCopy(), true),
			...
			appendChecksWithFullMetadataMatchingNone = func(
				...
				return append(
					...
					check{
						...
						req:                       &etcdserverpb.DeleteRangeRequest{Key: key, RangeEnd: rangeEnd},
						matchErr:                  Succeed(),
						expectMetaHead:            expectMetaHead(currentMetaHead, currentDataHead, true),
