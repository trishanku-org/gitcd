...
echo "Using ADMIN_SERVER_URL=${ADMIN_SERVER_URL}, KCM_SERVER_URL=${KCM_SERVER_URL}, SCHEDULER_SERVER_URL=${SCHEDULER_SERVER_URL}, KUBELET_SERVER_URL=${KUBELET_SERVER_URL}, PROXY_SERVER_URL=${PROXY_SERVER_URL}"
